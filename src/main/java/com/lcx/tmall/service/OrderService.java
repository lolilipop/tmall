...
import com.lcx.tmall.dao.OrderDAO;
...
public class OrderService {
    ...
    @Autowired
    OrderDAO orderDAO;
    @Autowired OderItemService orderItemService;
    public Page4Navigator<Order> list(int start,int size,int navigatepPages){
        Sort sort = new Sort(Sort.Direction.DESC,"id");
        Pageable pageable = new PageRequest(start,size,sort);
        Page pageFormJPA = orderDAO.findAll(pageable);
       return new Page4Navigator<>(pageFormJPA,navigatepPages);
